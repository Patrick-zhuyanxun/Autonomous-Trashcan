  ...
  useEffect(() => {
    ...
    <div className='container'>
        ...
        <img src="/title7.png" className="title"/>
            ...
            <rank>Rank</rank>
            <volume>Highest Recycling Volume</volume>
            <div className="child">
                <div className='rankfirst'/>
                <h2>{recyclelist[0]}</h2>  
                <h2>{recycleweightlist[0]} g</h2>
            </div>
            <div className="child">
                <div className='ranksecond'/>
                <h2>{recyclelist[1]}</h2>  
                <h2>{recycleweightlist[1]} g</h2>
            </div>
            <div className="child">
                <div className='rankthird'/>
                <h2>{recyclelist[2]}</h2>  
                <h2>{recycleweightlist[2]} g</h2>
            </div>
